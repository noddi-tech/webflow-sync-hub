-- Fix: Allow Navio's Feature/MultiPolygon GeoJSON format

-- 1. Alter the geometry column to accept MultiPolygon
ALTER TABLE public.areas 
  ALTER COLUMN geofence TYPE geometry(MultiPolygon, 4326)
  USING ST_Multi(geofence);

-- 2. Update the trigger function to handle Feature objects and MultiPolygons
